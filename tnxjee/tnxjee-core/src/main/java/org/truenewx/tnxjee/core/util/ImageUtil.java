...
public class ImageUtil {
     ...
     */
    public static byte[] clip(InputStream in, String formatName, int x, int y, int width, int height)
            throws IOException {
    ...
    public static BufferedImage clip(BufferedImage image, String formatName, int x, int y, int width, int height)
            throws IOException {
     ...
     */
    public static void save(BufferedImage image, String dir, String filename, String extension) throws IOException {
        ...
        try {
            ...
            output = new FileOutputStream(dir + IOUtil.FILE_SEPARATOR + filename + Strings.DOT + extension);
     ...
     * @throws IOException 系统没有写入权限
     */
    public static void save(byte[] bytes, String dir, String filename, String extension) throws IOException {
        FileOutputStream output = null;
        try {
            File file = new File(dir);
            if (!file.exists()) { // 因在实例化FileOutputStream时如果Dir未存在会报错,所以先保证dir有效
