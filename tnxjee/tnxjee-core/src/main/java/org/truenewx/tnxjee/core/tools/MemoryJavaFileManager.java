...
public class MemoryJavaFileManager implements JavaFileManager {
    ...
    /**
     * Returns a class loader for loading plug-ins from the given location. For example, to load
     * annotation processors, a compiler will request a class loader for the
     * {@link StandardLocation#ANNOTATION_PROCESSOR_PATH ANNOTATION_PROCESSOR_PATH} location.
     *
     * @param location a location
     * @return a class loader for the given location; or {@code null} if loading plug-ins from the given
     *         location is disabled or if the location is not known
    ...
    /**
     * Lists all file objects matching the given criteria in the given location. List file objects in
     * "subpackages" if recurse is true.
     * <p>
     * Note: even if the given location is unknown to this file manager, it may not return {@code null}.
     ...
     * @throws IOException           if an I/O error occurred, or if {@link #close} has been called and
     *                               this file manager cannot be reopened
     * @throws IllegalStateException if {@link #close} has been called and this file manager cannot be
     *                               reopened
     */
    @Override
    ...
    /**
     * Infers a binary name of a file object based on a location. The binary name returned might not be
     * a valid binary name according to <cite>The Java&amp;trade { throw new
     * UnsupportedOperationException("Not supported yet."); } Language Specification</cite>.
     *
     * @param location a location
     ...
     * @return the number of arguments the given option takes or -1 if the option is not supported
     */
    @Override
    ...
    public boolean handleOption(String current, Iterator<String> remaining) {
        this.logger.debug("handleOption: current: {}", current + ", remaining: " + remaining);
    ...
    interface ClassFileCreationListener {
        void newClassFile(OutputMemoryJavaFileObject jfo, Location location, String className, Kind kind,
                FileObject sibling);
    }
    ...
    /**
     * Returns a {@linkplain JavaFileObject file object} for input representing the specified class of
     * the specified kind in the given location.
     *
     * @param location  a location
     * @param className the name of a class
     * @param kind      the kind of file, must be one of {@link Kind#SOURCE SOURCE} or {@link Kind#CLASS
     *                  CLASS}
     ...
     *                                  not valid
     * @throws IOException              if an I/O error occurred, or if {@link #close} has been called
    ...
    /**
     * Returns a {@linkplain JavaFileObject file object} for output representing the specified class of
     * the specified kind in the given location.
     * <p>
     * Optionally, this file manager might consider the sibling as a hint for where to place the output.
     * The exact semantics of this hint is unspecified. The JDK compiler, javac, for example, will place
     * class files in the same directories as originating source files unless a class file output
     * directory is provided. To facilitate this behavior, javac might provide the originating source
     ...
     * @throws IllegalArgumentException if sibling is not known to this file manager, or if the location
     *                                  is not known to this file manager and the file manager does not
     *                                  support unknown locations, or if the kind is not valid
     * @throws IOException              if an I/O error occurred, or if {@link #close} has been called
     *                                  and this file manager cannot be reopened
    ...
    /**
     * Returns a {@linkplain FileObject file object} for input representing the specified
     * <a href="JavaFileManager.html#relative_name">relative name</a> in the specified package in the
     * given location.
     * <p>
     * If the returned object represents a {@linkplain Kind#SOURCE source} or {@linkplain Kind#CLASS
     * class} file, it must be an instance of {@link JavaFileObject}.
     * <p>
     * Informally, the file object returned by this method is located in the concatenation of the
     * location, package name, and relative name. For example, to locate the properties file
     * "resources/compiler.properties" in the package "com.sun.tools.javac" in the
     * {@linkplain StandardLocation#SOURCE_PATH SOURCE_PATH} location, this method might be called like
     * so:
     *
     * <pre>
     ...
     * <code>"C:\Documents&nbsp;and&nbsp;Settings\UncleBob\src\share\classes"</code>, a valid result
     * would be a file object representing the file
    ...
    /**
     * Returns a {@linkplain FileObject file object} for output representing the specified
     * <a href="JavaFileManager.html#relative_name">relative name</a> in the specified package in the
     * given location.
     * <p>
     * Optionally, this file manager might consider the sibling as a hint for where to place the output.
     ...
     * <p>
     * Informally, the file object returned by this method is located in the concatenation of the
     * location, package name, and relative name or next to the sibling argument. See
     * {@link #getFileForInput getFileForInput} for an example.
     *
     * @param location     a location
     * @param packageName  a package name
     * @param relativeName a relative name
     ...
     * @throws IllegalArgumentException if sibling is not known to this file manager, or if the location
     *                                  is not known to this file manager and the file manager does not
     *                                  support unknown locations, or if {@code relativeName} is not
     *                                  valid
     * @throws IOException              if an I/O error occurred, or if {@link #close} has been called
     *                                  and this file manager cannot be reopened
     * @throws IllegalStateException    if {@link #close} has been called and this file manager cannot
    ...
    /**
     * Flushes any resources opened for output by this file manager directly or indirectly. Flushing a
     * closed file manager has no effect.
     *
    ...
    /**
     * Releases any resources opened by this file manager directly or indirectly. This might render this
     * file manager useless and the effect of subsequent calls to methods on this object or any objects
     * obtained through this object is undefined unless explicitly allowed. However, closing a file
     * manager which has already been closed has no effect.
     *
     * @throws IOException if an I/O error occurred
     * @see #flush
     */
