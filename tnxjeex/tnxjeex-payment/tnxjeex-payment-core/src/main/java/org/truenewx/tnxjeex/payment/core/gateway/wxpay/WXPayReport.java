...
class WXPayReport {
    ...
    public static class ReportInfo {
        ...
        public String toString() {
            return "ReportInfo{" + "version='" + this.version + '\'' + ", sdk='" + this.sdk + '\'' + ", uuid='"
                    + this.uuid + '\'' + ", timestamp=" + this.timestamp + ", elapsedTimeMillis="
                    + this.elapsedTimeMillis + ", firstDomain='" + this.firstDomain + '\'' + ", primaryDomain="
                    + this.primaryDomain + ", firstConnectTimeoutMillis=" + this.firstConnectTimeoutMillis
                    + ", firstReadTimeoutMillis=" + this.firstReadTimeoutMillis + ", firstHasDnsError="
                    + this.firstHasDnsError + ", firstHasConnectTimeout=" + this.firstHasConnectTimeout
    ...
    private static String REPORT_URL = "http://report.mch.weixin.qq.com/wxpay/report/default";
    // private static String REPORT_URL = "http://127.0.0.1:5000/test";

    private static int DEFAULT_CONNECT_TIMEOUT_MS = 6 * 1000;
