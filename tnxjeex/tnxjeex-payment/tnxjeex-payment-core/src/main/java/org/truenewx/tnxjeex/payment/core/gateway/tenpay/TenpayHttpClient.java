...
class TenpayHttpClient {
    ...
    private static String USER_AGENT_VALUE = "Mozilla/4.0 (compatible; MSIE 6.0; Windows XP)";

    private static String JKS_CA_FILENAME = "tenpay_cacert.jks";

    private static String JKS_CA_ALIAS = "tenpay";

    private static String JKS_CA_PASSWORD = "";
