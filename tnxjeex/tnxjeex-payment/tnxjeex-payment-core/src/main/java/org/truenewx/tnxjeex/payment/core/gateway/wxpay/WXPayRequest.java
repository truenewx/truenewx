...
class WXPayRequest {
     ...
     * @throws Exception
     */
    private String requestOnce(String domain, String urlSuffix, String uuid, String data, int connectTimeoutMs,
            int readTimeoutMs, boolean useCert) throws Exception {
        BasicHttpClientConnectionManager connManager;
        if (useCert) {
            // 证书
            char[] password = this.config.getMerchantId().toCharArray();
        ...
        httpPost.addHeader("User-Agent", USER_AGENT + " " + this.config.getMerchantId());
    ...
    public String requestWithoutCert(String urlSuffix, String uuid, String data, boolean autoReport) throws Exception {
        return this.request(urlSuffix, uuid, data, this.config.getHttpConnectTimeoutMs(),
                this.config.getHttpReadTimeoutMs(), false, autoReport);
    }
    ...
    public String requestWithCert(String urlSuffix, String uuid, String data, boolean autoReport) throws Exception {
        return this.request(urlSuffix, uuid, data, this.config.getHttpConnectTimeoutMs(),
                this.config.getHttpReadTimeoutMs(), true, autoReport);
    }
